...
| 原语 · `delegate` | CEO 下达子任务 | `depends_on` 定 DAG；根侧默认协调（**含单 worker**；立即返回、同回合再调追加同一张图）；`coordinate=false` / 嵌套 lead / checkpoint 闸开走阻塞 | [编排器 §一–二](/docs/03-AI核心/编排器与CEO主Agent.md) |
