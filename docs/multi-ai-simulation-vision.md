...
| Desktop 观测页 | 3D Low-Poly 小镇鸟瞰 + 右侧事件流/居民面板；SSE 实时流、时间轴回放 |
...
**验收**：第二场景接入时无需重写 WorldEngine / SimAgent 核心；非技术用户可在桌面端观看 50+ tick 模拟。
...
| 独立 Web 应用（可选） | 便于 AI 小镇病毒性传播，服务大众用户 |
...
| 3 | 目标用户优先级 | 研究机构 / 政策智库 > 企业战略 > 大众教育。**产品策略**：用 AI 小镇的病毒性传播获取大众用户，后续再用经济沙盘等深度场景服务研究/教育/政策用户 | ✅ 已确认 |
