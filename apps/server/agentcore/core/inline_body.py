...
Canonical home is ``core.inline_body`` so ``runtime`` can weave pills without
importing ``conversation``. Desktop mirror: ``apps/desktop/src/renderer/lib/inlineBody.ts``.
"""
