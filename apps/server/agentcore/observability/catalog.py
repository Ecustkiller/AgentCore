...
EVENTS: list[EventSpec] = [
    ...
    EventSpec(name='chat.followups_failed'),
    EventSpec(name='chat.followups_provider_unavailable'),
    ...
    EventSpec(name='cost.prompt_assembled'),
    EventSpec(
        name='cost.recorded',
    ...
    EventSpec(name='delegate.code_fix_write_scope_lifted'),
    ...
    EventSpec(name='delegate.repair_code_criteria_forced'),
    ...
    EventSpec(name='engine.persist_write_grant'),
    ...
    EventSpec(name='followups.sanitize_empty'),
    EventSpec(name='followups.timeout'),
    ...
    EventSpec(name='routing.gate.scheme_escalation'),
    EventSpec(
    ...
    EventSpec(name='workflow.run_credentials_failed'),
    EventSpec(name='workflow.run_failed'),
    EventSpec(name='workflow.run_finished'),
    EventSpec(name='workflow.run_user_missing'),
