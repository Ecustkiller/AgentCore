...
EVENTS: list[EventSpec] = [
    ...
    EventSpec(name='consult_memory.cache_seeded'),
    EventSpec(name='consult_memory.hit'),
    EventSpec(name='consult_memory.miss'),
    EventSpec(name='consult_memory.reuse'),
    EventSpec(name='consult_rule.hit'),
    EventSpec(name='consult_rule.miss'),
    EventSpec(name='consult_skill.hit'),
    EventSpec(name='consult_skill.miss'),
    ...
    EventSpec(name='contract.hard_gap_blocked_completion'),
    ...
    EventSpec(name='coordination.harvest_cancelled_attached_inject'),
    ...
    EventSpec(name='coordination.idle_yield_to_captain'),
    ...
    EventSpec(name='cost.ledger_enqueue_no_conversation'),
    ...
    EventSpec(
        ...
        description='系统提示装配观测（段 chars + assembly_hash；零行为副作用）',
        fields={
    ...
    EventSpec(name='debate.deep_research_auto_skip_kickoff'),
    ...
    EventSpec(name='debate.team_preview_paused'),
    ...
    EventSpec(name='delegate.cold_start_explore_rejected'),
    EventSpec(
    ...
    EventSpec(name='delegate.team_preview_paused'),
    ...
    EventSpec(name='handoff.empty_body_blocked'),
    ...
    EventSpec(name='memory.injection_truncated'),
    ...
    EventSpec(name='memory.migrate_agentcore_failed'),
    ...
    EventSpec(name='memory.migrate_documents_failed'),
    ...
    EventSpec(name='project_catalog.list_failed'),
    EventSpec(name='project_catalog.profile_load_failed'),
    EventSpec(name='project_fs.bind_failed'),
    EventSpec(name='project_fs.target_opened'),
    EventSpec(name='projects.create_failed'),
    EventSpec(name='projects.created'),
    EventSpec(name='projects.list_failed'),
    EventSpec(name='projects.listed'),
    EventSpec(name='projects.resolve_failed'),
    EventSpec(name='projects.resolved'),
    ...
    EventSpec(name='resume.window_from_frame_fallback'),
    ...
    EventSpec(name='sidecar.outbox_checkpoint_missing_user_message_id'),
    ...
    EventSpec(name='simulation.scripted_opt_in'),
    ...
    EventSpec(name='tool.read_url_error'),
