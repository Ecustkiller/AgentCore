...
EVENTS: list[EventSpec] = [
    ...
    EventSpec(name='archive.create_done'),
    EventSpec(name='archive.extract_done'),
    EventSpec(
        name='archive_create.done',
        description='历史兼容：曾为独立 archive_create 工具完成事件；现为 archive.create_done',
    ),
    EventSpec(
        name='archive_extract.done',
        description='历史兼容：曾为独立 archive_extract 工具完成事件；现为 archive.extract_done',
    ),
    ...
    EventSpec(
        ...
        description='历史兼容：曾为附件视觉计费失败；现并入 file_read 路径，不再发此事件',
    ),
    ...
    EventSpec(
        ...
        description='历史兼容：曾为独立 read_image 工具读图；现并入 file_read，不再发此事件',
    ),
    EventSpec(
        name='read_image.vision_failed',
        description='历史兼容：曾为独立 read_image 视觉失败；现并入 file_read，不再发此事件',
    ),
