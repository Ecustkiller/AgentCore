...
EVENTS: list[EventSpec] = [
    ...
    EventSpec(
        name='attachment.vision_billing_failed',
        description='历史兼容：曾为附件视觉计费失败；现并入 read 路径，不再发此事件',
    ),
    ...
    EventSpec(name='compaction.dull_line'),
    EventSpec(name='compaction.dull_line_failed'),
    EventSpec(
    ...
    EventSpec(
        name='consult.skill_replacements_load_failed',
    ...
    EventSpec(name='conversation.trash_purged'),
    ...
    EventSpec(name='debate.turn_ledger_attach_failed'),
    ...
    EventSpec(name='delegate.conversation_id_as_folder_rejected'),
    ...
    EventSpec(name='delegate.empty_rejected'),
    EventSpec(
    ...
    EventSpec(name='desk_folder_label.cloud_failed'),
    ...
    EventSpec(name='edit.collision'),
    EventSpec(name='edit.scope_rejected'),
    ...
    EventSpec(name='engine.window_compact'),
    EventSpec(name='engine.window_compact_failed'),
    ...
    EventSpec(name='folders.owner_cloud_failed'),
    EventSpec(name='folders.owner_db_unavailable'),
    EventSpec(name='folders.resolve_failed'),
    EventSpec(name='folders.resolved'),
    EventSpec(name='folders.restored'),
    EventSpec(name='folders.trash_purged'),
    ...
    EventSpec(name='journal.envelope_stamp_failed'),
    EventSpec(
    ...
    EventSpec(
        name='llm.http_pool.warmed',
        description='出站 LLM HTTP 握手（GET /models；ok=False 为握手失败，不发补全）',
        fields={
            'host': FieldType('str'),
            'ok': FieldType('bool'),
        },
    ...
    EventSpec(name='memory.delete_skipped_no_cloud_api'),
    ...
    EventSpec(name='memory.save_skipped_no_cloud_api'),
    EventSpec(name='memory.save_skipped_prepare_cache_only'),
    EventSpec(name='memory.scope_chain_failed'),
    EventSpec(name='memory.user_rule_failed'),
    EventSpec(name='memory.user_rule_rewarm_failed'),
    EventSpec(name='memory.user_rule_written'),
    ...
    EventSpec(
        ...
        description='历史兼容：曾为独立 read_image 工具读图；现并入 read，不再发此事件',
    ),
    EventSpec(
        name='read_image.vision_failed',
        description='历史兼容：曾为独立 read_image 视觉失败；现并入 read，不再发此事件',
    ),
    ...
    EventSpec(
        ...
        description='sandboxd 启动云桌出站 SSRF 代理失败（仍监听 socket）',
        fields={
            'error': FieldType('str'),
        },
    ),
    ...
    EventSpec(
        name='sidecar.warm_llm_http',
        description='输入框首次聚焦后握手 LLM 出站连接（GET /models，不发补全）',
        fields={
            'ok': FieldType('bool'),
        },
    ),
    EventSpec(
        name='sidecar.warm_llm_http_failed',
        description='warmLlmHttp 握手任务意外失败',
        fields={
            'error': FieldType('str'),
        },
    ),
    ...
    EventSpec(
        name='team_preview.research_first_rejected',
        description='历史兼容：曾把已退役的先调研续跑选项降级为停止；契约已拒收，不再发此事件',
    ),
    ...
    EventSpec(
        ...
        description='工具开始执行（web_fetch 带 url/host）',
        fields={
            'host': FieldType('str'),
            'tool': FieldType('str'),
            'url': FieldType('str'),
    ...
    EventSpec(name='turn_lease.boot_sweep_failed'),
    ...
    EventSpec(name='turn_queue.drain_block_check_failed'),
    EventSpec(name='turn_queue.durable_write_failed'),
    EventSpec(name='turn_queue.edited'),
    EventSpec(name='turn_queue.enqueued'),
    EventSpec(name='turn_queue.enqueued_no_live_sink'),
    EventSpec(name='turn_queue.reordered'),
    EventSpec(name='turn_queue.restore_failed'),
    EventSpec(name='turn_queue.restored'),
    ...
    EventSpec(name='working_set.fold_traces_failed'),
    ...
    EventSpec(
        ...
        description='工作区原子写 replace 重试耗尽后降级原地 write_bytes（与 write 同档）',
        fields={
            'error': FieldType('str'),
            'target': FieldType('str'),
        },
    ...
    EventSpec(
        ...
        description='工作区文件清单 listing 失败（best-effort，不挡回合）',
        fields={
            'error': FieldType('str'),
        },
    ),
    ...
    EventSpec(name='write.collision'),
    EventSpec(name='write.scope_rejected'),
    EventSpec(name='write.stale_overwrite_rejected'),
]
