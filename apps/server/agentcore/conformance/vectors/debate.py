...
def _multi_agent_debate_multibeat() -> list[SSEEvent]:
    ...
    cx1 = [
        _ctx_block("task", "质询环节", "## 第 1 轮 · 质询环节\n请逐条正面回答质询。\n1. 质询题"),
        _ctx_block("cross_exam", "第 1 轮 · 质询（必须正面回答）", "- 质询题"),
    ]
    cx2 = [
        _ctx_block("task", "质询环节", "## 第 2 轮 · 质询环节\n请逐条正面回答质询。\n1. 质询题"),
