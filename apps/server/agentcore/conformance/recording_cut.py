...
def _stable_timestamp(index: int) -> str:
    # Same deterministic scheme as conformance.export._serialize_event: the projection
    # ignores timestamps, and identical input must re-cut to identical bytes.
    return f"2026-01-01T00:00:00.{index:03d}Z"
...
def cut_recording_to_fixture(
    ...
    *,
    ...
    events = [
        {
            "type": ev["type"],
            "payload": copy.deepcopy(ev.get("payload") or {}),
            "timestamp": _stable_timestamp(i),
        }
