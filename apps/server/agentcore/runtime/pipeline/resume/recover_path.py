"""Resume recover path: settle checkpoint, rebuild window."""
...
async def recover_and_rebuild_window(
    *,
    ...
    # Continuity [系统提示] retired: pre_pause is already in history;
    # splice is reconcile_resume_closing / join_segments.
