...
_ASSESS_SYSTEM = (
    ...
    "③ 记分裁判——给各方本轮的【论证有效性 / 证据 / 是否正面回应（含质询）】打分：证据分必须按"
    "【来源等级】挂钩——"
    "司法文书/官方原文 > 权威媒体 > 自媒体/百科/转述"
    "（高等级可给满；决定性事实仅挂权威媒体且无交叉印证=中等封顶；仅自媒体/百科/转述=弱、"
    "evidence 封顶打低）。【已核实】若挂在弱源（自媒体/百科/转述）上，必须在 note 或 penalties"
    "中点名该弱源；逻辑谬误（如循环论证）与【把待核实 / 无据主张硬拗成既定事实】必须扣分"
    "（但辩手【诚实标注待核实】不罚——诚实存疑是美德不是罪）；质询回应上【诚实认输 / 让步 ≠ 回避】"
    "——正面接招但承认弱点 / 缺证据算正面回应（论点让步由 argument 维体现），只有答非所问 / "
    "打太极 / 复述立论不接招才算回避、才压低 engagement——这仍是辩论【领域内】的判定，不是通用"
    "文笔质量门。三项判断互不迁就、都要诚实。严格只输出要求的 JSON。"
)
...
async def judge_and_summarize(
    ...
    **跨轮论点账本（收敛校准 §三 H2）**：``history`` 除定 round_no / 小结锚点外，还经
    ...
    user = (
        ...
        "①【司法文书/官方原文】（判决书 / 裁定书 / 官方公告 / 一手档案 / 原始数据 / 财报）= 强、可给满；"
        "②【权威媒体】（主流通讯社 / 严肃报刊原发报道）= 中高，决定性事实若仅单一权威媒体且无交叉印证"
        "则封顶中等；③【自媒体/百科/转述】（自媒体、百科词条、二手转述、论坛汇总）= 弱、evidence 封顶打低。"
