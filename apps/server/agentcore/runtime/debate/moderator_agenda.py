...
_OPENING_SPEC = (
    ...
    "语体与专业辩论主持同域，庄重、赛制感，不对用户称「你」。按三拍结构写成连贯 2–3 句"
    "（约 80–120 字）：①【宣题】用主持人语言概括本场辩题/案由（提炼说法，勿逐字照抄 motion）；"
    "②【亮场】介绍各方及其主张——正反辩论用「正方主张…／反方主张…」；红队审查用「方案方提出…／"
    "红队将审查…」；多方圆桌用「各方将从…等视角展开」；③【定焦】点明首轮焦点，并交代为何它是"
    "本场关键。禁网络梗、过度比喻、寒暄客套；不剧透结论、不站队。口吻示范："
    "『本场就「公司是否应全面转向远程办公」展开辩论。正方主张效率与成本优势，反方主张协作与"
    "组织文化风险。首轮焦点落在协作效率的净影响——它直接决定方案能否站得住。』\n"
)
