...
TS_EXPORTS: tuple[TsExport, ...] = (
    ...
    TsInterface(run.RunIntakePayload),
    TsInterface(run.RunEscalationGatePayload),
    TsInterface(run.RunSplitAssessedPayload),
    TsInterface(run.RunSubworkerStartedPayload),
    TsInterface(run.RunSubworkerCompletedPayload),
    ...
    TsInterface(debate.DebateRoundDecisionRequiredPayload),
    TsInterface(debate.DebateRoundDecisionResolvedPayload),
    ...
    TsInterface(chat.Citation),
    TsInterface(chat.CitationsPayload),
...
EVENT_PAYLOAD_MODELS: dict[EventType, type[BaseModel]] = {
    ...
    EventType.RUN_INTAKE: run.RunIntakePayload,
    EventType.RUN_ESCALATION_GATE: run.RunEscalationGatePayload,
    EventType.RUN_SPLIT_ASSESSED: run.RunSplitAssessedPayload,
    EventType.RUN_SUBWORKER_STARTED: run.RunSubworkerStartedPayload,
    EventType.RUN_SUBWORKER_COMPLETED: run.RunSubworkerCompletedPayload,
    ...
    EventType.DEBATE_ROUND_DECISION_REQUIRED: debate.DebateRoundDecisionRequiredPayload,
    EventType.DEBATE_ROUND_DECISION_RESOLVED: debate.DebateRoundDecisionResolvedPayload,
    ...
    EventType.CITATIONS: chat.CitationsPayload,
