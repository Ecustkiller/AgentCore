...
This package is the local-engine half of 工作区 §七 (Sidecar
...
Persistence is progressive **OutboxStore** on disk (as-built: 工作区.md §七):
...
``docs/02-架构/工作区.md``（完全离线为提案；详细提案不在公开仓）。
"""
