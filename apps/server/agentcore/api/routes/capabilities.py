...
capability packs as a display catalog, and the CEO system-prompt template. Skills /
packs are derived from the SAME sources the runtime wires so the 图鉴 never drifts
from the live turn.
"""
