...
从 ``apps/server`` 跑::
    ...
    uv run python scripts/probe_turn.py "联网搜一下 Python 3.13 新特性，简短三点"
    uv run python scripts/probe_turn.py --raw "..."               # 连每个 delta 都打
    uv run python scripts/probe_turn.py --conversation <id> "..."  # 复用已有会话
