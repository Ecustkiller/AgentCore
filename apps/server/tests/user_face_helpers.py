...
# Engine vocabulary the product never exposes. ``工具 '`` (quoted tool name) is the
# giveaway that a model-facing sentence leaked verbatim.
...
# Orders that only make sense aimed at the model. The last one is worse than jargon: on an
