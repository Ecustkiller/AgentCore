 ...
 * representative beat to show the real two-way exchange (AppShellStill is now a
 * fanout freeze; debate stills use this offset). Only DebateConnector reads this prop; nodes/edges
