...
import { entranceStyle } from "../motion/primitives";
import { CHAPTER_FRAMES, type ChapterDef } from "./types";

/** Data-driven act title card. Frame is chapter-local when nested in a Sequence. */
