 ...
 * not import film-package demo layout.
 */
 ...
 *
 * `cinematic` (stills) makes it the image's centerpiece: a blurred glow
 ...
 * their camp. Kit GraphRun leaves this off for the plain product connector.
 */
