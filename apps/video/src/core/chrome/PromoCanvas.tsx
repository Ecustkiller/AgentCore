 ...
 * canvas parks on.
 *
 * Demo task title / graph snapshot / bbox come from the caller (film or still
 * package) — core does not import films/.
 */
    ...
    >
      ...
      <div style={{ position: "relative", height: FOCUS_BODY_H, ...DOT_GRID }}>
        <GraphStage
          nodes={settled}
          edges={edges}
          debate={debate ? { ...debate, active: true } : null}
          frame={frame}
          cinematic
          boxWidth={FOCUS_W}
