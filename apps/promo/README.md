...
>
> **别搞混**：这支是「协作智能」主题的**脚本化复刻**品牌片；另有一支「谁更聪明」主题的**真录多模型辩论**视频（不同概念），见 [真·多模型辩论与谁更聪明视频](/docs/07-规划/真多模型辩论与谁更聪明视频.md)。
...
- 另一支视频（不同概念）：[真·多模型辩论与谁更聪明视频](/docs/07-规划/真多模型辩论与谁更聪明视频.md)
