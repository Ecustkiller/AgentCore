...
import { buildGraphState } from "../graph/graphState";
...
const SPINE_FROZEN = 240; // demo butterfly at the 辩论对射 beat (research done, debate live)
const FPS = 30;
const FOCUS_W = 860;
...
function FocusedTurnCard() {
  const { nodes, edges, debate } = buildGraphState(SPINE_FROZEN, FPS);
