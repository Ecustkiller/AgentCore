  ...
  return (
    <>
      ...
      <main id="top" className="relative z-10">
        ...
        <section className="relative z-0 flex min-h-[94vh] flex-col justify-center overflow-hidden bg-[var(--ink-deep)] pb-24 pt-24 xl:min-h-[88vh] xl:pb-16 xl:pt-28">
          <div
            aria-hidden="true"
          ...
          <div className="container-x relative grid items-center gap-14 xl:grid-cols-[minmax(0,1fr)_minmax(0,1.06fr)] xl:gap-16">
            <div>
              ...
              <p
                className="float-in mt-3 font-mono text-[0.6875rem] uppercase tracking-[0.14em] text-faint"
            ...
            <div className="text-center">
              ...
              <Reveal>
                <RichTitle
                  ...
                  className="display-title mx-auto sm:whitespace-nowrap"
                />
              </Reveal>
              <Reveal delay={90}>
          ...
          <div className="container-x relative z-[2]">
            ...
            <Reveal>
              <RichTitle
                ...
                className="display-title mb-10 text-paper-ink sm:mb-14 sm:whitespace-nowrap"
              />
            </Reveal>
            ...
            <div id="role" className="mt-20 scroll-mt-28 sm:mt-28">
              ...
              <Reveal>
                <RichTitle
                  ...
                  className="display-title mb-3 text-[clamp(1.875rem,3.8vw,3rem)] text-paper-ink sm:whitespace-nowrap"
                />
              </Reveal>
              <Reveal delay={80}>
                <p className="display-lead mb-12 text-paper-dim sm:mb-16 sm:whitespace-nowrap">
                  {t(ROLE.lead)}
                </p>
              </Reveal>
            ...
            <Reveal delay={220}>
              <ul className="mt-8 flex flex-wrap justify-center gap-2 sm:mt-10">
                {CLOSING.trust.map((item) => (
                  <li
                    key={item.zh}
                    className="rounded-full border border-border-soft px-3.5 py-1.5 font-mono text-[0.65625rem] uppercase tracking-[0.12em] text-faint"
                  >
                    {t(item)}
                  </li>
                ))}
