...
export const APP_STATIC_ROUTES: readonly string[] = [
  ...
  APP_PATHS.toolbox.mine.tools,
  APP_PATHS.toolbox.mine.creation,
  APP_PATHS.toolbox.mine.automations,
  APP_PATHS.toolbox.mine.workflows,
  APP_PATHS.toolbox.mcp,
  APP_PATHS.toolbox.market,
  APP_PATHS.toolbox.official,
  APP_PATHS.toolbox.guides,
