...
const DEMO_ROUNDS: DebateRoundModel[] = [
  {
    ...
    sides: [
      roundSide("pro", "加速派", "run_pro_1", "deepseek/deepseek-chat"),
      roundSide("con", "审慎派", "run_con_1", "deepseek/deepseek-chat"),
    ],
    clashes: [],
    inFlight: false,
    userInterjections: [],
  ...
  },
  {
    ...
    sides: [
      roundSide("pro", "加速派", "run_pro_2", "deepseek/deepseek-chat"),
      roundSide("con", "审慎派", "run_con_2", "deepseek/deepseek-chat"),
    ],
    clashes: [],
    inFlight: false,
    userInterjections: [],
