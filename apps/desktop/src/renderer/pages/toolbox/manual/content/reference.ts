      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: "删了能找回",
              desc: "对话删掉不弹确认，进「最近删除」，保留期内都能恢复：刚删完点提示上的「撤销」，或去「全部对话」页左边的「最近删除」。对话连同全部消息回到原来的位置，但公开分享链接不会一起回来，需要重新分享。进「最近删除」后也可以彻底删除（再确认一次）。文件夹删除仍弹窗：这张桌的 AI 设定一并退出，恢复时和归档的对话一起回来；白板留在顶层白板列表。弹窗里勾「立即永久删除」，或之后在「最近删除」里彻底删除，才连设定一起不可逆清掉。本机文件夹在你电脑上的文件，删除与恢复都不会动。",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              a: [
                {
                  type: "text",
                  text: "文件在你的文件夹里（本机文件夹、「我的文件」，或别人邀请你的协作桌「与我共享」）；对话记录在后端，用于续聊与记忆。文件页随时看、随时导出。",
                },
              ],
            },
            {
