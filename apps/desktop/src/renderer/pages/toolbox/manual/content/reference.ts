      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              title: "删了能找回",
              desc: "对话和文件夹删掉后，保留期内都能恢复：删完那条提示上点「撤销」，或去「全部对话」页左边的「最近删除」。对话连同全部消息回到原来的位置，但删除时撤销的公开分享链接不会一起回来，需要重新分享；恢复文件夹会把它一并归档的对话带回来，白板则留在顶层白板列表。删除弹窗里勾「立即永久清除」才是不可逆的。本机文件夹在你电脑上的文件，删除与恢复都不会动。",
            },
          ],
        },
        {
