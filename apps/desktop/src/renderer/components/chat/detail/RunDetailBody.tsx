  ...
  return (
    <div className="p-4">
      ...
      {run.debrief ? (
        ...
        // Legacy / captain fallback: a journal written before 交接简报 surfacing (or any run
        // that carried only a plain summary) still shows its 结论 here.
        <Section title="结论">
 ...
 */
function DebriefSection({ debrief }: { debrief: RunDebrief }) {
