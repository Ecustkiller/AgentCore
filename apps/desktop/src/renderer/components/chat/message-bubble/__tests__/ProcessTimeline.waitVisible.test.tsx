...
/**
 * Thinking tail around team markers. A settled tool does not suppress it.
 */
import {
  ProcessTimeline,
...
describe("ProcessTimeline · team tail", () => {
...
describe("shouldShowThinkingTail", () => {
  ...
  it("keeps the completed-tool tail and hides a running tool", () => {
