 ...
 *
 * 曾按「库里有没有对话」判定，于是一次失败 / 中途放弃 / 误触新建之后，示例任务
 * 就一起永久消失——第二次回来的人反而更没抓手。现在按「有没有一来一回跑成过」判。
 */
...
describe("DraftEmptyState", () => {
  it("offers starter tasks to a brand-new user, without a how-to lecture", () => {
    renderEmptyState();
