      ...
      <div className="border-b border-border px-3 py-2">
        <div className="relative">
          ...
          <input
            ...
            placeholder="搜索场景…"
            aria-label="搜索场景"
            className="w-full rounded-lg border border-input bg-background py-1.5 pl-8 pr-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-ring focus:outline-none"
          />
        </div>
      </div>
